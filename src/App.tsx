...
export function App() {
  ...
  const [isAllEmployeeSelected, setEmployeeSelected] = useState<string | null>(null)
      ...
      <main className="MainContainer">
        ...
        <InputSelect<Employee>
          ...
          onChange={async (newValue) => {
            ...
            setEmployeeSelected(newValue.id)
        ...
        <div className="RampGrid">
          {transactions === null ? (
            ...
            <Fragment>
              ...
              {data.transactions.length !== transactions.length && !isAllEmployeeSelected && (
              <button
